...
| **España** cuenta con una encuesta de turismo nacional, relevada en hogares (Encuesta de turismo de residentes -[ETR/FAMILITUR](https://www.ine.es/dyngs/INEbase/es/operacion.htm?c=Estadistica_C&cid=1254736176990&menu=ultiDatos&idp=1254735576863){target="_blank"}-) que permite conocer el origen y destino de todos los viajes turísticos que realizan los residentes de ese país. Esta encuesta cuenta con representatividad a nivel de comunidad autónoma (el equivalente a las provincias en Argentina) e incluye en su cobertura a toda la población, independientemente del contexto (rural, urbano) en que resida.

| Por otra parte, posee un relevamiento de movimientos fronterizos a partir del cual da cuenta del turismo internacional ([FRONTUR](https://www.ine.es/dyngs/INEbase/es/operacion.htm?c=Estadistica_C&cid=1254736176996&menu=ultiDatos&idp=1254735576863){target="_blank"}), mientras que a partir de una encuesta de caracterización y gasto del turismo internacional ([EGATUR](https://www.ine.es/dyngs/INEbase/es/operacion.htm?c=Estadistica_C&cid=1254736177002&menu=ultiDatos&idp=1254735576863){target="_blank"}), que incluye todos sus segmentos (al contemplar la totalidad de las vías de acceso en su muestra) puede estimar cuanto de este flujo corresponde a cada comunidad autónoma.
...
En el caso de [Canadá](https://www150.statcan.gc.ca/n1/en/subjects/travel_and_tourism){target="_blank"}, también cuenta con una encuesta a hogares que mide el turismo nacional [National Travel Survey -NTS-](https://www23.statcan.gc.ca/imdb/p2SV.pl?Function=getSurvey&SDDS=5232){target="_blank"} y con una encuesta de turismo internacional [Visitor Travel Survey -VTS-](https://www23.statcan.gc.ca/imdb/p2SV.pl?Function=getSurvey&SDDS=5261){target="_blank"}. En ambos casos, (y también en el de los relevamientos de ocupación de alojamientos turísticos), se trata de estudios con representatividad provincial.
