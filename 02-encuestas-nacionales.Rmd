...
La muestra abarca a hogares residentes en los "grandes aglomerados urbanos" definidos en la Encuesta Permanente a Hogares del INDEC (63%[^2] del total de la población argentina, aproximadamente), excluyendo de este modo a los residentes en ciudades medianas y pequeñas, en pueblos y en zonas rurales.

[^2]: El Área Metropolitana de Buenos Aires (AMBA), conformada por la Ciudad de Buenos Aires y los Partidos del Gran Buenos Aires, tiene una cobertura del 100%, mientras que en el conjunto del Interior del país la cobertura es de aproximadamente el 44%.

Lógicamente, aquellos visitantes residentes en el exterior del país tampoco son alcanzados por este operativo.
Debido a que la encuesta se realiza en el lugar de residencia u origen de los visitantes y dada la cobertura geográfica del operativo, el análisis por origen de los visitantes estará limitado a los visitantes que provienen de los grandes aglomerados urbanos del país.En cambio, el análisis de los resultados por destino contemplará a todas las ciudades o localidades del país.
...
Los resultados de la EVyTH surgen de la agregación de datos calculados a nivel mensual en muestras independientes.
...
Debido a que la encuesta fue diseñada para obtener resultados a niveles regionales, las estimaciones provinciales deben ser consideradas con cautela: la cantidad de hogares encuestados en los aglomerados de cada provincia varía sustancialmente: lógicamente, a mayor cantidad de muestra, mayor fiabilidad (menor error estadístico) presentarán las estimaciones (véase Figura 2.1).
...
![](https://lh5.googleusercontent.com/DyAnrDcgeOEDJNn5zwo64eZQdOb1uwRxM3d-q4YsCoPQ6w6mWq09s0o3owBCyTP8IvPWeyphobXNa8CfQF6Y-dUnZUn5GkUw4UfPVzDQWQolPF8zVDxnntruFp5GVn-W-MLVCQ)
...
**Figura 2.2. Cobertura de la EOH. Porcentaje aproximado que representan las plazas de las localidades incluidas en la EOH respecto al total de plazas provinciales.**

![](https://lh5.googleusercontent.com/Eolm_BYa1dEmoPEifu9WkFqJ3K5vfWlW1V3wi3VUEEIGpjIPF3LV6WUnmdBwoBt0RkrH6ZsZID1OrUiPZHKLJWzGCi2Q3cfoaxxyqqrcdJwHdmZJe-JD298v2RUWCzA7FjD-2w)
...
Cabe señalar que la EOH excluye de su universo a los establecimientos pequeños (menos de 6 habitaciones o de 13 plazas).
...
Asimismo, al analizar viajeros hospedados (o huéspedes), no se distingue entre visitantes y viajeros no visitantes.
...
Releva a los viajeros no residentes de Argentina que visitaron el país (al salir del país) y a los viajeros residentes en Argentina que viajan al exterior (al volver al país).

Cubre el movimiento internacional de cinco puntos de entrada y salida del país: Aeropuerto de Ezeiza, Aeroparque Jorge Newbery, Aeropuerto de Córdoba (Pajas Blancas), Aeropuerto de Mendoza (El Plumerillo), Puerto de Buenos Aires y el paso fronterizo terrestre Sistema Cristo Redentor, que representan aproximadamente la mitad del flujo internacional de viajeros, dejando fuera de análisis los ingresos y egresos por otros puntos de frontera.
...
A partir del año 2018 la pregunta de los destinos visitados (itinerario) en Argentina es de tipo abierta y se registra todos ellos lugares donde el turista realiza al menos una pernoctación junto con el tipo de alojamiento utilizado.
...
knitr::include_graphics('imagenes/figura2.3.jpg')
```
...
knitr::include_graphics('imagenes/figura2.4.png')
```
