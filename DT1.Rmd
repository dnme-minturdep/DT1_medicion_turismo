...
[ETR/Familitur Encuesta de turismo de residentes](https://www.ine.es/dyngs/INEbase/es/operacion.htmc=Estadistica_C&cid=1254736176990&menu=ultiDatos&idp=1254735576863)

[FRONTUR](https://www.ine.es/dyngs/INEbase/es/operacion.htmc=Estadistica_C&cid=1254736176996&menu=ultiDatos&idp=1254735576863)

[EGATUR](https://www.ine.es/dyngs/INEbase/es/operacion.htmc=Estadistica_C&cid=1254736177002&menu=ultiDatos&idp=1254735576863)

En el caso de **Canadá**, también cuenta con una encuesta a hogares que mide el turismo nacional (National Travel Survey -NTS-) y con una encuesta de turismo internacional (Visitor Travel Survey -VTS-). En ambos casos, (y también en el de los relevamientos de ocupación de alojamientos turísticos), se trata de estudios con representatividad provincial.
...
[Canadá](https://www150.statcan.gc.ca/n1/en/subjects/travel_and_tourism)

[National Travel Survey (NTS)](https://www23.statcan.gc.ca/imdb/p2SV.pl?Function=getSurvey&SDDS=5232)

[Visitor Travel Survey (VTS)](https://www23.statcan.gc.ca/imdb/p2SV.pl?Function=getSurvey&SDDS=5261)

<!--chapter:end:01-flujo-turistico.Rmd-->
...
[Data abierta](http://datos.yvera.gob.ar/dataset/encuesta-viajes-turismo-hogares-evyth)

[Informes técnicos](https://www.yvera.tur.ar/estadistica/info/encuesta-de-viajes-y-turismo-de-los-hogares-evyth)
:::

[Encuesta Permanente a Hogares del INDEC](https://www.indec.gob.ar/indec/web/Institucional-Indec-OperacionesEstadisticas)

## EOH {#eoh}

La **Encuesta de Ocupación Hotelera (EOH)** es un relevamiento realizado en forma continua desde el 2004, bajo la [coordinación del MINTURDEP y el Instituto Nacional de Estadísticas y Censos (INDEC)](https://www.indec.gob.ar/indec/web/Nivel4-Tema-3-13-56), que tiene como objetivo medir el impacto del turismo interno e internacional sobre la actividad de los establecimientos hoteleros y para-hoteleros.
...
[Doc metodológico (INDEC)](https://www.indec.gob.ar/ftp/cuadros/economia/eoh_aspectos_metodologicos.pdf) 
:::

## ETI {#eti}

La **Encuesta de Turismo Internacional (ETI)** es otro operativo realizado en forma continua desde el año 2004, [coordinado conjuntamente por el MINTURDEP y el INDEC](https://www.indec.gob.ar/indec/web/Nivel4-Tema-3-13-55).
...
Para ver un ejemplo de cómo el MINTURDEP utiliza los datos de estas encuestas para obtener resultados a nivel de provincia se pueden visitar las fichas de "[Estadísticas de turismo por provincia](https://www.yvera.tur.ar/estadistica/info/estadisticas-de-turismo-por-provincias)".

<!--chapter:end:02-encuestas-nacionales.Rmd-->
...
<!--chapter:end:03-Consideraciones-finales.Rmd-->

`r if (knitr::is_html_output()) '
# Bibliografía {-}
'`

<!--chapter:end:04-bibliografia.Rmd-->
